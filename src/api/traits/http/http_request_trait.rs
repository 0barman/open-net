...
pub trait HttpRequestTrait: Send {
    ...
    fn get_req_data(&self) -> String {
        crate::log_t!(LogType::HTTP; "get_req_data");
        String::new()
    }
    ...
    fn headers(&self) -> HashMap<&'static str, String> {
        crate::log_t!(LogType::HTTP; "headers");
        HashMap::new()
    }
    ...
    fn should_output_log(&self) -> bool {
        crate::log_t!(LogType::HTTP; "should_output_log");
        true
    }
    ...
    fn on_response_headers(&self, _headers: &HeaderMap) {
        crate::log_t!(LogType::HTTP; "on_response_headers");
    }
