...
async fn module_whitelist_multiple_clients_replace_clone_and_shutdown() {
    ...
    on_common::log_t!(LogType::HTTP; "module_filter_probe");
    on_common::log_t!(LogType::WSS; "module_filter_probe");
    on_common::log_t!(LogType::Engine; "module_filter_probe");
    on_common::log_t!(LogType::None; "module_filter_probe");
    on_common::log_t!(LogType::Database; "module_filter_probe");
    on_common::log_t!(LogType::Common; "module_filter_probe", "source", "shared");
    on_common::log_t!(LogType::WSC; "module_filter_probe", "source", "websocket");
    ...
    on_common::log_s!(LogType::WSC; "module_filter_probe", "step", "replacement");
    ...
    on_common::log_s!(LogType::WSC; "module_filter_probe", "step", "removed_a");
    next(&mut b_rx).await;
    assert!(
    ...
    on_common::log_s!(LogType::WSC; "module_filter_probe", "step", "closed_b");
    ...
    on_common::log_t!(LogType::WSC; "module_filter_probe");
    assert!(
...
async fn public_listener_observes_entry_arguments_and_api_error() {
    ...
    client
        ...
        .unwrap();
    on_common::log_t!(LogType::WSC; "argument_probe", "a1|b1", 7, "text");
...
async fn listener_can_query_and_unregister_itself_without_feedback_or_runtime() {
    ...
    client
        .try_set_log_listener(Some(Box::new(move |log| {
            ...
            on_common::log_t!(LogType::WSC; "reentry_probe");
...
async fn blocked_log_callback_does_not_block_network_io_or_shutdown() {
    ...
    client
        ...
        .unwrap();
    on_common::log_t!(LogType::WSC; "slow_network_probe");
