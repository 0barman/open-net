...
impl From<on_common::CommonError> for NetError {
    fn from(value: on_common::CommonError) -> Self {
        on_common::log_t!(on_common::log::log_def::LogType::Engine; "from", "error", format!("{value:?}"));
        match value {
            on_common::CommonError::RuntimeError => Self::RuntimeError,
            on_common::CommonError::PostError => Self::PostError,
            on_common::CommonError::None => Self::Unknown,
        }
    }
}
...
impl From<tokio_tungstenite::tungstenite::Error> for NetError {
    fn from(value: tokio_tungstenite::tungstenite::Error) -> Self {
        on_common::log_t!(on_common::log::log_def::LogType::WSC; "from", "error", on_common::log::summary::error(&value));
