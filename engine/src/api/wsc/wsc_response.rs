...
impl WSCResponse {
    pub(crate) fn new(
        ...
        on_common::log_t!(LogType::WSC; "new", "message_bytes|pending_requests|connection_generation", message.len(), "PendingRequestView", connection_generation);
    ...
    pub fn message(&self) -> &Message {
        on_common::log_t!(LogType::WSC; "message");
        &self.message
    }

    pub fn into_message(self) -> Message {
        on_common::log_t!(LogType::WSC; "into_message");
        self.message
    }
    ...
    pub fn get_request(&self, uuid: &str) -> Option<Arc<dyn WSRequestTrait>> {
        on_common::log_t!(LogType::WSC; "get_request", "uuid", uuid);
    ...
    pub fn take_request(&self, uuid: &str) -> Option<Arc<dyn WSRequestTrait>> {
        on_common::log_t!(LogType::WSC; "take_request", "uuid", uuid);
        self.pending_requests
    ...
    pub fn received_at(&self) -> SystemTime {
        on_common::log_t!(LogType::WSC; "received_at");
        self.received_at
    }

    pub fn connection_generation(&self) -> u64 {
        on_common::log_t!(LogType::WSC; "connection_generation");
